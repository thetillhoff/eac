...
wget -q "https://github.com/thetillhoff/transcrypt/releases/download/v$1/transcrypt-linux-amd64" -O "$2/transcrypt-linux-amd64"
sudo install -D -g root -o root -m 755 "$2/transcrypt-linux-amd64" "/usr/local/bin/transcrypt"
