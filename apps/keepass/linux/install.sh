...
wget -q "https://github.com/thetillhoff/keepass/releases/download/v$1/keepass-linux-amd64" -O "$2/keepass-linux-amd64"
sudo install -D -g root -o root -m 755 "$2/keepass-linux-amd64" "/usr/local/bin/keepass"
