...
wget -q "https://github.com/cli/cli/releases/download/v$1/gh_$1_linux_amd64.tar.gz" -O "$2/github-cli-linux-amd64.tar.gz"
mkdir $2/extracted
tar -xzf "$2/github-cli-linux-amd64.tar.gz" -C "$2/extracted"
sudo install -D -g root -o root -m 755 "$2/extracted/gh" "/usr/local/bin/gh"
